...
function BookTrip() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const totalPrice = calculatePrice(); // Calculate price
  ...
  // Calculate price with a discount for stays over 7 days
  const calculatePrice = () => {
    ...
    const discount = days > 7 ? 0.9 : 1; // 10% discount for trips longer than a week
