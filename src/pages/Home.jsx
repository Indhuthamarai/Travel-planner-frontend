...
//           <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl italic">
//             <span className="block text-gray-800">Discover the Beauty of</span>
//             <span className="block text-blue-700">Incredible India</span>
//           </h1>
//           <p className="mt-3 max-w-md mx-auto text-lg text-gray-700 italic sm:text-xl md:mt-5 md:text-2xl md:max-w-3xl">
...
//         <div className="mt-16">
//           <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center italic text-blue-900">Popular Destinations</h2>
//           <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
//             {/* Destination Cards */}
//             <div className="bg-gray-50 overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-300">
//               <img
...
//       {/* Footer Section */}
//       <footer className="bg-gray-500 text-gray-300 py-8 mt-12 italic">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="text-center">
//             <h3 className="text-lg font-semibold text-white-100">Contact Us</h3>
//             <p className="mt-2 text-white-50">Email: support@tourstravel.com | Phone: +123-456-7890</p>
//             <p className="mt-2 text-white-50">Address: 123 Adventure Road, Travel City, Earth</p>
//             <Link
//               to="/contact"
...
//             <p className="text-gray-500">© 2024 Tours Travel. All rights reserved.</p>
//           </div>
//         </div>
//       </footer>
//     </div>
      ...
      <footer className="bg-gray-700 text-gray-300 py-8 mt-12 italic">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-400">Email: support@tourstravel.com | Phone: +123-456-7890</p>
            <p className="mt-2 text-gray-400">Address: 123 Adventure Road, Travel City, Earth</p>
            <Link
              to="/contact"
              className="mt-4 inline-block text-gray-100 hover:text-gray-200 font-medium"
            >
